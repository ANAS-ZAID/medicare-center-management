...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $erorrs = AdminsController::handilngDataAdmin(fileetrRequest("adminName"), fileetrRequest("email"), fileetrRequest("password"),fileetrRequest("confairmPassword"));
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="adminName" autocomplete="off" required autofocus
                                class="form-control" value="<?php echo getOldData('adminName');?>">
