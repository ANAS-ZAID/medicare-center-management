...
$reservation = ReservationsController::fetchReservationById($_GET['id']);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $erorrs = ReservationsController::updateReservation($_GET['id'],fileetrRequest("patientId"), fileetrRequest("doctorId"), fileetrRequest("status"), fileetrRequest("date"));
                        ...
                        <div class="form-group">
                            ...
                            <select name="patientId" class="form-control">
                                ...
                                <option value="<?php echo $patient->id?>"
                                    <?php echo $reservation->patientId==$patient->id?"selected":'' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="doctorId" class="form-control">
                                ...
                                <option value="<?php echo $doctor->id?>"
                                    <?php echo $reservation->doctorId==$doctor->id?"selected":'' ?>>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="date" minlength="9" maxlength="9" autocomplete="off" required
                                autofocus class="form-control" value="<?php echo $reservation->date;?>">
                        </div>
                        <?php
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="status" autocomplete="off"
                                class="form-control"><?php echo $reservation->status ;?> </textarea>
                        </div>
                    </div>
