...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $erorrs = CategoriesController::handilngDataCategory(fileetrRequest("categoryName"), fileetrRequest("ordering"), fileetrRequest("visibility"),fileetrRequest("allowComments"),fileetrRequest("allowAds"),fileetrRequest("discription"));
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="categoryName" autocomplete="off" required autofocus
                                class="form-control" value="<?php echo getOldData('categoryName');?>">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="allowComments" class="form-control">
                                <option value="0" <?php echo getOldData('allowComments')==0?"selected":'' ?>>
                                    <?php echo translate("disabled") ?>

                                </option>
                                <option value="1" <?php echo getOldData('allowComments')==1?"selected":'' ?>>
                                    <?php echo translate("enabled") ?>
