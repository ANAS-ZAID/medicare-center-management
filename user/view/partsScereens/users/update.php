...
$user = UsersController::fetchUserById($_GET['id']);
if ($user['status']) {
    $user = $user['data'];
} else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty(fileetrRequest("password"))||!empty(fileetrRequest("confairmPassword"))) {
        ...
        $password=$user->password;$confairmPassword= $user->password;
    }
   
    $erorrs = UsersController::handilngDataUser(fileetrRequest("userName"), fileetrRequest("email"), $password, $confairmPassword,$user->id, "update");
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="userName" autocomplete="off" required class="form-control"
